package ma.ac.emi.ginfo.backend.http.header;
...
public class HeaderGenerator {
	...
	public HttpHeaders getHeadersForSuccessPostMethod(jakarta.servlet.http.HttpServletRequest request, Long newResourceId) {
		HttpHeaders httpHeaders = new HttpHeaders();
		try {
